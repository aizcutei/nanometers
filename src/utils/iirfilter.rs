...
pub fn multiband_mid_filter(x_0: f32, buffer: &mut IIRBuffer) -> f32 {
    let y_0 = LP2000_B[0] * x_0 + LP2000_B[1] * buffer.x_1 + LP2000_B[2] * buffer.x_2
        - LP2000_A[0] * buffer.y_1
        - LP2000_A[1] * buffer.y_2;
    let z_0 = HP200_B[0] * y_0 + HP200_B[1] * buffer.y_1 + HP200_B[2] * buffer.y_2
        - HP200_A[0] * buffer.z_1
        - HP200_A[1] * buffer.z_2;
    buffer.x_2 = buffer.x_1;
    buffer.x_1 = x_0;
    buffer.y_2 = buffer.y_1;
    buffer.y_1 = y_0;
