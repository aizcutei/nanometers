...
pub const SHELVING_B0: f32 = 0.73248077421585;
...
pub fn combined_filter(x_0: f32, buffer: &mut IIRBuffer) -> f32 {
    let y_0 = SHELVING_B0 * x_0
        + SHELVING_B1 * buffer.x_1
        + SHELVING_B2 * buffer.x_2
        + SHELVING_A1 * buffer.y_1
        + SHELVING_A2 * buffer.y_2;
    let z_0 = HIGHPASS_B0 * y_0
        + HIGHPASS_B1 * buffer.y_1
        + HIGHPASS_B2 * buffer.y_2
